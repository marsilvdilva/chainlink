...
type TriggerRegistrationMetadata struct {
	...
	// Todo make struct instead of serialized string (no backwards compatibility issues here so we should do it the right way)
...
const file_core_capabilities_remote_types_messages_proto_rawDesc = "" +
	...
	"\n" +
	"\bmetadataJ\x04\b\a\x10\bJ\x04\b\b\x10\t\"\xb7\x01\n" +
